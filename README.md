...
- Debug 测试包示例：`https://download.204152.xyz/releases/ai-translate-1.0.4-debug.apk`
...
- R2 更新清单：`https://download.204152.xyz/releases/latest.json` 当前可访问；1.0.4 Debug 更新包由 `scripts/publish-r2-debug-update.ps1` 上传，大小 `192197321` 字节，SHA256 为 `9D23DC42093334EEDDAFECE3A5A7A156FDEC5B2FF4785BD33F72072EB2F9721F`。
